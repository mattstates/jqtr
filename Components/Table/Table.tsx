...
import { ModifiedJiraIssue, JiraIssue } from '../../types/JiraTypes';
...
class Table extends React.Component<ITableProps> {
     ...
     */
    resourceAccumulator(taskCollection: any, ignoreSubtasks = false) {
        return taskCollection.reduce((totals: any, task: any) => {
    ...
    formatSubTableDataByViewType(viewType: VIEW_TYPES, rowInfo: any) {
        switch (viewType) {
            case VIEW_TYPES.INITIATIVE:
            ...
            case VIEW_TYPES.ASSIGNEE:
                return rowInfo
                    .filter((task: JiraIssue) => !task.omitFromJqtr)
